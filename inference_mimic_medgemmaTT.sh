...
CKPT_PATH="/pvc/Sana/output/Llavarad_Captions/Sana_${SIZE}M_${RESOLUTION}/checkpoints/epoch_20_step_12381.pth"
...
PROMPTS_TEXT_FILE="/pvc/CheXGenBench/MIMIC_Splits/MEDGEMMA_TT_ANNOTATIONS_TEST.txt"
